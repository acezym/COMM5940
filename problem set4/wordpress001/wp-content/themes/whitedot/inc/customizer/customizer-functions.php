...
function whitedot_customizer_google_fonts() {
	...
	if( 'font-2' === get_theme_mod( 'whitedot_google_fonts' ) ) {  
        ...
        wp_enqueue_style( 'whitedot-google-font-Alfa-Slab-One', 'https://fonts.googleapis.com/css?family=Alfa+Slab+One', false );
        ...
        wp_enqueue_style( 'whitedot-google-font-Mr-Dafoe', 'https://fonts.googleapis.com/css?family=Mr+Dafoe', false );

    }elseif ('font-22' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-EB-Garamond', 'https://fonts.googleapis.com/css?family=EB+Garamond', false );

    }elseif ('font-23' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Economica', 'https://fonts.googleapis.com/css?family=Economica', false );

    }elseif ('font-24' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-El-Messiri', 'https://fonts.googleapis.com/css?family=El+Messiri', false );

    }elseif ('font-25' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Electrolize', 'https://fonts.googleapis.com/css?family=Electrolize', false );

    }elseif ('font-26' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Encode-Sans', 'https://fonts.googleapis.com/css?family=Encode+Sans', false );

    }elseif ('font-27' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Encode-Sans-Condensed', 'https://fonts.googleapis.com/css?family=Encode+Sans+Condensed', false );

    }elseif ('font-28' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Encode-Sans-Expanded', 'https://fonts.googleapis.com/css?family=Encode+Sans+Expanded', false );

    }elseif ('font-29' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Englebert', 'https://fonts.googleapis.com/css?family=Englebert', false );

    }elseif ('font-30' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Enriqueta', 'https://fonts.googleapis.com/css?family=Enriqueta', false );

    }elseif ('font-31' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Esteban', 'https://fonts.googleapis.com/css?family=Esteban', false );

    }elseif ('font-32' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Exo', 'https://fonts.googleapis.com/css?family=Exo', false );

    }elseif ('font-33' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Expletus-Sans', 'https://fonts.googleapis.com/css?family=Expletus+Sans', false );

    }elseif ('font-34' === get_theme_mod( 'whitedot_google_fonts' ) ) { 

        wp_enqueue_style( 'whitedot-google-font-Josefin-Slab', 'https://fonts.googleapis.com/css?family=Josefin+Slab', false );
