...
class Woo_Checkout_For_Digital_Goods_Admin {
    ...
    public function enqueue_styles() {
        if (isset($_GET['page']) && !empty($_GET['page']) && ($_GET['page'] == 'woo-checkout-fields')) {
    ...
    public function welcome_screen_content_woocommerce_digital_counter() {
        ...
        <div class="wrap about-wrap">
            ...
            <h1 style="font-size: 2.1em;"><?php printf(esc_html__('Welcome to Woocommerce Checkout For Digital Goods', 'woo-checkout-for-digital-goods')); ?></h1>
            ...
            <div class="return-to-dashboard">
                <a href="<?php echo esc_url(home_url('/wp-admin/admin.php?page=woo-checkout-fields')); ?>"><?php esc_html_e('Go to Woocommerce Checkout For Digital Settings','woo-checkout-for-digital-goods'); ?></a>
            </div>
        </div>
